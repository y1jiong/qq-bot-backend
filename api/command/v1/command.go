...
type (
	CommandReq struct {
		...
		Signature   string `json:"signature" v:"required" description:"以 token+command+group_id+timestamp+message_sync+async 为原文，以 token_name 为 key 的 HmacSha1 值的 base64 值"`
	}
	CommandRes struct {
