...
type (
	IToken interface {
		...
		ChangeTokenOwnerReturnRes(ctx context.Context, ownerId string, name string) (retMsg string)
		BindTokenBotId(ctx context.Context, botId string, name string) (retMsg string)
